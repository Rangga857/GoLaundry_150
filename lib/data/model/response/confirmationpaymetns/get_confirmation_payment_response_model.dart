...
class GetConfirmationPaymentResponseModel {
    final String success;
    final ConfirmationPayment confirmationPayment;

    GetConfirmationPaymentResponseModel({
        required this.success,
        required this.confirmationPayment,
    });

    GetConfirmationPaymentResponseModel copyWith({
        String? success,
    ...
    factory GetConfirmationPaymentResponseModel.fromRawJson(String str) => GetConfirmationPaymentResponseModel.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory GetConfirmationPaymentResponseModel.fromJson(Map<String, dynamic> json) => GetConfirmationPaymentResponseModel(
